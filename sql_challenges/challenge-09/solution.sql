...
SELECT DBMS_METADATA.GET_DDL('TABLE', 'MY_TABLE') FROM DUAL;
  ...
  CREATE TABLE "A01645073_SCHEMA_3B17T"."TASKS" 
   (	"ID" NUMBER GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  NOT NULL ENABLE, 
	...
	"TYPE" VARCHAR2(10), 
	"ASSIGNED_DEV_ID" VARCHAR2(50), 
	"DUE_DATE" TIMESTAMP (6), 
	"CREATED_AT" TIMESTAMP (6) DEFAULT SYSTIMESTAMP, 
	"UPDATED_AT" TIMESTAMP (6), 
	 CHECK (
        status IN ('TODO', 'IN_PROGRESS', 'BLOCKED', 'IN_REVIEW', 'DONE')
    ) ENABLE, 
	 CHECK (
...
WHERE ROWNUM = 1;
  ...
  CREATE TABLE "A01645073_SCHEMA_3B17T"."ACCOUNTS" 
   (	"ACCOUNT_ID" NUMBER, 
...
FK_PET_LOG_PRODUCT	PET_CARE_LOG	SYS_C002824698
FK_TASK_LOG_TASK	TASK_LOG	SYS_C003188564
...
SELECT DBMS_METADATA.GET_DDL('PACKAGE', object_name) FROM user_objects WHERE object_type = 'PACKAGE';
  ...
  CREATE OR REPLACE EDITIONABLE PROCEDURE "A01645073_SCHEMA_3B17T"."DEPOSIT_FUNDS" (
